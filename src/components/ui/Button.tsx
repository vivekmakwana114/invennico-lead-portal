...
export function Button({
  ...
  const variantStyles = {
    primary: "bg-primary text-secondary shadow-primary/20 hover:shadow-primary/40",
    secondary: "bg-secondary text-quaternary border border-gray-200 hover:bg-gray-50 active:bg-primary active:text-secondary focus:bg-primary focus:text-secondary transition-colors",
