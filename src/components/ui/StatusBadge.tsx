...
const STATUS_MAP: Record<string, { label: string; className: string }> = {
  ...
  "engagement-started": { label: "Engagement Started", className: "bg-yellow-50 text-yellow-700 border border-yellow-200" },
  ...
  drop:                 { label: "Dropped",            className: "bg-error-bg text-error-text border border-error-border" },
};
